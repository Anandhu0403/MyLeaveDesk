        ...
        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
            <thead>
                <tr>
                    ...
                    <th style="text-align:center">Leave Title</th></th>
			...
			<?php
				...
				if(isset($_POST["btn_search"])) {
				    ...
				    $tdate = $_POST["tdate"];
				    if ($fdate && $tdate) {
				        $sel .= " AND l.leave_fromdate BETWEEN '$fdate' AND '$tdate'";
				    }
				}
			...
			?>
             ...
             <tr>
                 ...
                 <td align="center"><?php echo $data["leave_title"]; ?></td>
                 <td align="center"><?php echo $data["leave_fromdate"]; ?></td>
                 <td align="center"><?php echo $data["leave_enddate"]; ?></td>
                 <td align="center"><?php echo $data["leave_content"]; ?></td>
