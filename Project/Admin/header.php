  ...
  <aside class="sidebar">
    <div class="sidebar-start">
        <div class="sidebar-head">
            <a href="AdminHomepage.php" class="logo-wrapper" title="Home">
        ...
        <div class="sidebar-body">
            ...
            <ul class="sidebar-body-menu">
                <li>
                    <a href="AdminProfile.php"></span>My Profile</a>
                </li>
                 <li>
                    <a href="Category.php"></span>Add Category</a>
                </li>
                 <li>
                    <a href="Department.php"></span>Add Department</a>
                </li>
                 <li>
                    <a href="District.php"></span>Add District</a>
                </li>
                 <li>
                    <a href="Place.php"></span>Add Place</a>
                </li>
                 <li>
                    <a href="Adminregistration.php"></span>Register</a>
                </li>
